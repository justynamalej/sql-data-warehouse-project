...
| customer_number | NVARCHAR(50) | Alphabetic identifier representic the customer, used for tracking and referencing. |
...
| birth_date | DATE | The birthdate of the customer, formatted as YYYY-MM-DD (e.g. 1997-08-15). |
...
| product_number | NVARCHAR(50) | A structured alphabetic code representing the product, often used for categorization on inventory. |
| products_name | NVARCHAR(50) | Descriptive name of the product, including key details such as type, color and size. |
...
| start_date | DATE | The date when the product became available for sales or use. |
...
| sales | INT | The total monetary value of the sale for the line item, in whole US units (e.g. 25). |
