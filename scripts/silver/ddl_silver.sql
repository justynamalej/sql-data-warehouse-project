...
============================
Script purpose:
	This script creates new tables in the 'silver' schema of the 'DWH_CRM_ERP' database.
	If the table already exists, it's dropped.
	Additioanlly dwh_create_date metadata column was added to each table to track creation time.
